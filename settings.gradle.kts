...
include(":sources:features:feature-splashscreen-ui")
include(":sources:features:feature-auth-api")
include(":sources:features:feature-auth-ui")
include(":sources:features:feature-main-container-ui")
include(":sources:features:feature-finances-ui")
include(":sources:features:feature-profile-ui")
include(":sources:features:feature-operations-api")
include(":sources:features:feature-analytics-ui")
include(":sources:common:common-error")
